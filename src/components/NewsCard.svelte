...
>
	...
	<div class="px-4 pb-2">
		...
		<div class="flex text-gray-700 dark:text-gray-50">
			<a class="font-conthrax pt-2 font-extrabold" href="/">Procitaj</a>
			<p class="font-conthrax w-full pt-2 text-right">{date}</p>
		</div>
	</div>
</div>
