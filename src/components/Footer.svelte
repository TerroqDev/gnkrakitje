...
<div class="3xl:px-98 bg-gray-900 px-4 text-gray-50 md:px-48">
	...
	<div class="grid grid-cols-1 justify-center pt-8 pb-4 md:grid-cols-2 md:pb-16">
		<div class="flex flex-col justify-center gap-2">
			...
			<div class="flex gap-4">
				<div class="w-6 py-2">
					...
					<a href="https://www.instagram.com/gnk_tigar_sveta_nedelja/" target="_blank">
				...
				<div class="w-6 py-2">
					<!-- svelte-ignore a11y_consider_explicit_label -->
					<a href="https://www.facebook.com/gnktigarsvetanedjelja/" target="_blank">
