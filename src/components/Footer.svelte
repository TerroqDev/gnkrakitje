...
<div class="3xl:px-98 bg-gray-900 px-4 text-gray-50 md:px-48">
	<h1 class="font-conthrax pt-4 text-center text-3xl font-extrabold">SPONZORI</h1>
	<div class="flex justify-center gap-4 pt-8 pb-8">
		<div class="flex h-20 w-32 items-center justify-center md:h-40 md:w-64">
			<img
				...
				src="https://woop14abphufecql.public.blob.vercel-storage.com/gnk/partneri/golf-fasade-white-01oBqHyvRx7QQMtVjHVLdiDeplQiCU.png"
				alt="Golf fasade"
			/>
		</div>
