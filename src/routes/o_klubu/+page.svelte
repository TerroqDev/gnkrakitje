<div class="flex h-full min-h-svh flex-col">
	...
	<div class="3xl:px-98 font-roboto px-4 pt-4 md:px-48 md:text-lg">
		<p>
	...
	<div class="3xl:px-98 flex w-full flex-col items-start px-4 pt-8 md:px-48">
		<div class="group flex gap-x-6">
			...
			<div class="-translate-y-1.5 pb-16 text-slate-600">
				<p class="font-roboto text-lg font-bold text-gray-800 antialiased">
					01.01.2023. Klub osnovan
				</p>
			</div>
		</div>
		<div class="group flex gap-x-6">
			...
			<div class="-translate-y-1.5 pb-16 text-slate-600">
				<p class="font-roboto text-lg font-bold text-slate-800 antialiased">29.03.2024.</p>
			</div>
		</div>
		<div class="group flex gap-x-6">
			<div class="relative">
			...
			<div class="-translate-y-1.5 pb-8 text-slate-600">
				<p class="font-roboto text-lg font-bold text-slate-800 antialiased">20.07.2025.</p>
			</div>
		</div>
	</div>
</div>
